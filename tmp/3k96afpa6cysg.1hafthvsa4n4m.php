...
<head>
    ...
    <script src="recursos/js/vendor/alpine-mask.min.js" defer></script> 
    ...
    <div class="d-flex flex-nowrap h-100">
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary toggled" style="width: 170px;">
            ...
            <?php if (strlen($SESSION['usuario']['fotoPerfilLocation']) == 0): ?>
                ...
                <?php else: ?>
                    <img src="<?= ('uploads/profile/'. $SESSION['usuario']['fotoPerfilLocation']) ?>" width="90" height="90" style="width: 7rem;" />
