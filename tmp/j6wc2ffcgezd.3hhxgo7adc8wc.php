<form action="/privado/perfil/guardar" method="post" class="col-sm-9 p-3">
        ...
        <div class="form-floating mb-3">
            <input class="form-control" id="nick" name="nickname" placeholder="nickname" value="<?= ($perfil['nickname']) ?>"></input>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" id="wsp" name="wsp" placeholder="XXXXXXXX" value="<?= ($perfil['wsp']) ?>" pattern="[0-9]{8}" maxlength="8" required>
        </div>
